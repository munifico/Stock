...
for cmp in rows :
    ...
    try:
        req = urllib.request.Request('https://navercomp.wisereport.co.kr/v2/company/c1010001.aspx?cmp_cd=' + StockCd, headers=hdr);
    ...
    try:
        req = urllib.request.Request('https://navercomp.wisereport.co.kr/v2/company/ajax/cF1001.aspx?cmp_cd=' + StockCd + '&fin_typ=0&freq_typ=Y&encparam=' + encParam + '&id=' + id, headers=hdr);
        soup_m = BeautifulSoup(urllib.request.urlopen(req).read(), "html.parser")
