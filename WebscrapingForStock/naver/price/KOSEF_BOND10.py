...
for i in range(1,2) :
    pageCont = urllib.request.urlopen('https://finance.naver.com/item/sise_day.nhn?code=148070&page=' + str(i));
    ...
    for j in tdArray : 
        if(j.contents.__len__() != 0 and j['class'][1] == 'p10') :
            ...
            cs.execute("INSERT INTO TB_KOPSEF_BOND10 VALUES('" + date.replace(".","-") + "'," + val.replace(",","") + ")")
        idx+=1;
